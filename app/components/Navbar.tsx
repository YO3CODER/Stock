...
const Navbar = () => {
    ...
    const navLinks = [
       ...
       { href: "/sell", label: "Vendre", icon: ShoppingCart }, // Changé de "Donner" à "Vendre" et HandHeart à ShoppingCart
        ...
        <div className='border-b border-base-300 px-5 md:px-[10%] py-4 relative'>
            <div className='flex justify-between items-center'>
                ...
                <div className='hidden space-x-2 sm:flex items-center'>
                    ...
                    {!isLoaded && <div className='w-8 h-8 rounded-full bg-gray-200 animate-pulse' />}
                </div>
            </div>
